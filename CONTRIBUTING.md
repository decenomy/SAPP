Contributing to Dash Diamond Core
============================

The Dash Diamond Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dash Diamond Core project, and is not to be
confused with overall Dash Diamond Network Protocol consensus changes.

Whether a pull request is merged into Dash Diamond Core rests with the project merge
...
Patches that change Dash Diamond consensus rules are considerably more involved than
...
Where a patchset proposes to change the Dash Diamond consensus, it must have been
...
The project leader is the release manager for each Dash Diamond Core release.
