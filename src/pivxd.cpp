 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called SAPP (http://www.sappcoin.com),
 * which enables instant payments to anyone, anywhere in the world. SAPP uses peer-to-peer technology to operate
