...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sappre Coin Core sapphire-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sapphire-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pivx transaction") + "\n" +
                               "  sapphire-tx [options] -create [commands]   " + _("Create hex-encoded pivx transaction") + "\n" +
                               "\n";
