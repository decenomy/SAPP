...
"is wrong Sapphire Core will not work properly."),
QT_TRANSLATE_NOOP("pivx-core", ""
...
QT_TRANSLATE_NOOP("pivx-core", "Copyright (C) 2015-%i The Sapphire Core Developers"),
...
QT_TRANSLATE_NOOP("pivx-core", "Error loading %s: Wallet requires newer version of Sapphire Core"),
...
QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. Sapphire Core is shutting down."),
...
QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart Sapphire Core to complete"),
