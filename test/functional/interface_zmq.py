...
from test_framework.test_framework import SapphireTestFramework, SkipTest
...
class ZMQTest (SapphireTestFramework):
    ...
    def setup_nodes(self):
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("sapphired has not been built with zmq enabled.")
