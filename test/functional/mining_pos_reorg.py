...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected SAPP and zSAPP supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check SAPP and zSAPP supply at the beginning
        # ------------------------------------------
        # zSAPP supply: 2 coins for each denomination
        ...
        # Verify that SAPP and zSAPP supplies were properly updated after the spends and reorgs
