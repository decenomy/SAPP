...
class PivxTestFramework():
    ...
    def _initialize_chain(self, toPosPhase=False):
        ...
        if not toPosPhase and not is_powcache_valid:
            ...
            # - Nodes 2 and 3 mint one zerocoin for each denom (tot 6666 SAPP) on block 301/302
            ...
            for peer in range(4):
                for j in range(20):
                    ...
                    if nBlocks == 301 or nBlocks == 302:
                        # mints 7 zerocoins, one for each denom (tot 6666 SAPP), fee = 0.01 * 8
                        # consumes 27 utxos (tot 6750 SAPP), change = 6750 - 6666 - fee
    ...
    def test_PoS_chain_balances(self):
        ...
        # - Nodes 2 and 3 have 6666 SAPP worth of zerocoins
