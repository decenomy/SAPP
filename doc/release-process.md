...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/sappcoin-com/SAPP/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/sPIVX-Project/PIVX/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Build and sign Sappre Coin Core for Linux, Windows, and macOS:
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/sappcoin-com/SAPP/releases/new) with a link to the archived release notes.
