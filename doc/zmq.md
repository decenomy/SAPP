...
router", implementing the sapphire wire protocol and relay, making
...
The ZeroMQ feature in Sapphire Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ sapphired -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/sapphired.tx.raw
