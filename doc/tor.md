...
The first step is running Sapphire behind a Tor proxy. This will already anonymize all
...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServiceDir /var/lib/tor/sapphire-service/
...
your sapphired's P2P listen port (51472 by default).
	...
	-externalip=X   You can tell sapphire about its publicly reachable address using
	                this option, and this can be a v2 .onion address (v3 .onion
	                addresses are not supported by the Sapphire network). Given the above
	                configuration, you can find your .onion address in
	                /var/lib/tor/sapphire-service/hostname. For connections
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./sapphired -proxy=127.0.0.1:9050 -externalip=sappzj6l4cvo2fxy.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./sapphired -onion=127.0.0.1:9050 -externalip=sappzj6l4cvo2fxy.onion -discover
