Sapphire Core version *3.1.0.2* is now available from:  <https://github.com/pivx-project/pivx/releases>
...
Sapphire Core v3.1.0.2 is a mandatory update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will have a grace period of one week to update their clients before enforcement of this update is enabled.
