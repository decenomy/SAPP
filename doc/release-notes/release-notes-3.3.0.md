Sappre Coin Core version *3.3.0* is now available from:  <https://github.com/pivx-project/pivx/releases>
...
The `masternode` and `mnbudget` RPC commands, which were marked as deprecated in Sappre Coin Core v2.3.1 (September 19, 2017), have now been completely removed from Sappre Coin Core.
