...
The script [extract-osx-sdk.sh](https://github.com/sappcoin-com/sapp/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
sapphire/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/sappcoin-com/sapp/blob/master/doc/README_osx.md) for troubleshooting tips.