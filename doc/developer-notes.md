...
- [Development guidelines](#development-guidelines)
    - [General Sappre Coin Core](#general-pivx-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Sappre Coin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Sappre Coin Core is a multi-threaded application, and deadlocks or other
...
However, in open source software such as Sappre Coin Core, where everyone uses
...
pay attention to for reviewers of Sappre Coin Core code.

General Sappre Coin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sappre Coin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Sappre Coin Core so that they can be integrated
...
file descriptors it will cause problems with SAPP's `select()` loop, because
