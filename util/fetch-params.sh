...
Failed to fetch the SAPP zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
SAPP - fetch-params.sh

This script will fetch the SAPP zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common SAPP zkSNARK parameters. Note that it is
