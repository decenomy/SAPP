...
Failed to fetch the DashDiamond zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
DashDiamond - fetch-params.sh

This script will fetch the DashDiamond zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common DashDiamond zkSNARK parameters. Note that it is
